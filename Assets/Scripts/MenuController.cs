...
{
    public int beersCollected; // Compteur de biéres collectées

    // Fonction pour une nouvelle partie
    public void NewGame()
    {
        // Nouvelle partie : le nombre de biéres bues est initialisé à 0
        beersCollected = 0;
        PlayerPrefs.SetInt("beersCollected", beersCollected);
        // Nouvelle partie : la liste des biéres spéciales est vidée
